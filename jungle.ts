// Ported from JS from https://voicechanger.io/js/jungle.js
function createFadeBuffer(context: OfflineAudioContext, activeTime: number, fadeTime: number): AudioBuffer {
...
function createDelayTimeBuffer(context: OfflineAudioContext, activeTime: number, fadeTime: number, shiftUp: boolean): AudioBuffer {
  var length1 = activeTime * context.sampleRate;
  var length2 = (activeTime - 2 * fadeTime) * context.sampleRate;
  var length = length1 + length2;
  var buffer = context.createBuffer(1, length, context.sampleRate);
